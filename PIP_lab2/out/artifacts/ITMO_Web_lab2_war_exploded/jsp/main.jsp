                ...
                <table width="100%">
                    <form id="inputForm" action="" method="get">
                        ...
                        <div class="button-div">
                            ...
                            <input type="checkbox"  class="r-button" value="1" onclick="drawArea(1)">1</input>
                            <input type="checkbox"  class="r-button" value="2" onclick="drawArea(2)">2</input>
                            <input type="checkbox"  class="r-button" value="3" onclick="drawArea(3)">3</input>
                            <input type="checkbox"  class="r-button" value="4" onclick="drawArea(4)">4</input>
                            <input type="checkbox"  class="r-button" value="5" onclick="drawArea(5)">5</input>
                        </div>
